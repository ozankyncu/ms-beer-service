...
import com.kyncu.beersystem.web.exceptions.NotFoundException;
...
public class BeerServiceImpl implements BeerService {
    ...
    // If key is Non specified, spring will generate for us
    // Cache beer by beerId key.
    ...
    @Cacheable(cacheNames = "beerUpcCache", condition = "#upc != null")
    @Override
